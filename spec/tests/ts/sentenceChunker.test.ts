// Ported verbatim (session-a-intelligence.md step 9's own "move the
// chunker to spec/") from frontend/src/lib/sentenceChunker.test.ts,
// which Session A does not own and could not delete or repoint here -
// see docs/dev.md's step 9 entry and its Session B follow-up note.
import { describe, expect, test } from "bun:test";
import { nextSentenceBoundary, splitReadyChunks } from "../../safety/ts/sentenceChunker.js";
