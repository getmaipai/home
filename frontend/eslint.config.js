...
export default tseslint.config(
  ...
  },
  {
    ...
    files: ["**/*.{ts,tsx}"],
    ignores: ["src/kit/icons.ts", "src/kit/ui/**"],
    rules: {
  ...
  {
    // Generated by the shadcn CLI, not authored here: a lint this session
    // added is for app code built on top of these files, not a mandate to
    // hand-patch every accessibility nuance of vendored component
    // internals (input-group.tsx's click-to-focus convenience click
    // handler is the one real trip today). The kit's own accessibility
    // floor (48px targets, focus rings, 16px text) was still applied by
    // hand where it mattered - see button.tsx, switch.tsx, checkbox.tsx,
    // input.tsx, select.tsx.
    files: ["src/kit/ui/**/*.tsx"],
    rules: {
  ...
  },
  {
    ...
    rules: {
      ...
      "better-tailwindcss/no-unknown-classes": [
        ...
        { ignore: ["brand-logo-light", "brand-logo-dark"] },
      ],
